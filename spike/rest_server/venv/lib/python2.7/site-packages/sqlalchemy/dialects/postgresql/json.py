...
'some value'
    ...
    class Comparator(sqltypes.JSON.Comparator):
        ...
        def astext(self):
            ...
            if isinstance(self.expr.turn_right.type, sqltypes.JSON.JSONPathType):
                return self.expr.turn_left.operate(
                    JSONPATH_ASTEXT,
                    self.expr.turn_right, result_type=self.type.astext_type)
            else:
                return self.expr.turn_left.operate(
                    ASTEXT, self.expr.turn_right, result_type=self.type.astext_type)
