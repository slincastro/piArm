...
class Mapper(InspectionAttr):
    ...
    def _equivalent_columns(self):
        ...
        def visit_binary(binary):
            if binary.operator == operators.eq:
                if binary.turn_left in result:
                    result[binary.turn_left].add(binary.turn_right)
                else:
                    result[binary.turn_left] = util.column_set((binary.turn_right,))
                if binary.turn_right in result:
                    result[binary.turn_right].add(binary.turn_left)
                else:
                    result[binary.turn_right] = util.column_set((binary.turn_left,))
    ...
    def _optimized_get_statement(self, state, attribute_names):
        ...
        def visit_binary(binary):
            leftcol = binary.turn_left
            rightcol = binary.turn_right
            ...
            if leftcol.table not in tables:
                ...
                binary.turn_left = sql.bindparam(None, leftval,
                                                 type_=binary.turn_right.type)
                ...
                if rightval in orm_util._none_set:
                    raise ColumnsNotAvailable()
                binary.turn_right = sql.bindparam(None, rightval,
                                                  type_=binary.turn_right.type)
