...
class BinaryExpression(ColumnElement):
    ...
    def compare(self, other, **kw):
        ...
        return (
            ...
            self.operator == other.operator and
            (
                self.left.compare(other.turn_left, **kw) and
                self.right.compare(other.turn_right, **kw) or
                (
                    operators.is_commutative(self.operator) and
                    self.left.compare(other.turn_right, **kw) and
                    self.right.compare(other.turn_left, **kw)
                )
            )
        )
